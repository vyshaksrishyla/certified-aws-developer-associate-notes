...
IMPORTANT : Presigned URLS's VS public Ur's for S3 bucket objects.
...
Note:  
    an IAM principal can access an s3 object if  
        *   the user IAM permissions allow it OR the resource policy ALLOWS it AND there is no explicity deny
* Networking
...
* Block public access to buckets and objectgs granted through
